 ...
 */
?>
<!-- wp:group {"align":"full","anchor":"book-your-stay","className":"moxy-hero-section","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull moxy-hero-section" id="book-your-stay"><!-- wp:group {"align":"full","className":"moxy-hero-slider js-moxy-slider","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull moxy-hero-slider js-moxy-slider"><!-- wp:group {"className":"moxy-hero-slides","layout":{"type":"constrained"}} -->
<div class="wp-block-group moxy-hero-slides"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( '/assets/images/moxy/ox-cocktails-bar-moxy-1-37112-classic-hor-resized.jpg' ) ); ?>","dimRatio":30,"overlayColor":"moxy-ink","isUserOverlayColor":true,"minHeight":780,"minHeightUnit":"px","className":"moxy-hero-slide is-active","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|x-large","left":"min(6vw, 4rem)","right":"min(6vw, 4rem)"}}}} -->
<div class="wp-block-cover moxy-hero-slide is-active" style="padding-top:var(--wp--preset--spacing--xx-large);padding-right:min(6vw, 4rem);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:min(6vw, 4rem);min-height:780px"><span aria-hidden="true" class="wp-block-cover__background has-moxy-ink-background-color has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background" alt="Couple having cocktails at hotel bar" src="<?php echo esc_url( get_theme_file_uri( '/assets/images/moxy/ox-cocktails-bar-moxy-1-37112-classic-hor-resized.jpg' ) ); ?>" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"bottom","align":"wide","className":"moxy-hero-slide__inner"} -->
...
<!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri( '/assets/images/moxy/ox-lifestyle-bar-moxy-36071.jpg' ) ); ?>","dimRatio":45,"overlayColor":"moxy-ink","isUserOverlayColor":true,"minHeight":780,"minHeightUnit":"px","className":"moxy-hero-slide","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|x-large","left":"min(6vw, 4rem)","right":"min(6vw, 4rem)"}}}} -->
...
<!-- wp:group {"align":"full","className":"moxy-booking-modal js-booking-modal","layout":{"type":"constrained"}} -->
