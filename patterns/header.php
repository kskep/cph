<?php
/**
 * Title: CityPlus Header
 * Slug: cph/header
 * Description: Header for the CityPlus Hotels front page.
 * Categories: header, cph/cph
 * Keywords: header, nav, CityPlus
 * Viewport Width: 1440
...
<a class="cph-header__logo-mark" href="/" aria-label="CityPlus Hotels home">
